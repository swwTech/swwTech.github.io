...
<div class="circle animate__animated animate__bounce" style="height:400px;width:400px;background-color:blue;position:fixed;z-index:-1;bottom:-170px; filter:blur(350px); opacity:0.5;left:-100px;"></div>
<div class="circle" style="height:400px;width:400px;background-color:green;position:fixed;z-index:-1;top:-170px; filter:blur(350px); opacity:0.5;right:-100px;"></div>
